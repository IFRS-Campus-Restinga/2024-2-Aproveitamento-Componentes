...
from .views.pedagogical_plan_view import PedagogicalPlanCourseListCreateView, PedagogicalPlanCourseRetrieveUpdateDestroyView
...
urlpatterns = [
    ...
    path("pedagogical-plans/", PedagogicalPlanCourseListCreateView.as_view(), name="pedagogical_plan_list_create"),
    path("pedagogical-plans/<uuid:pk>/", PedagogicalPlanCourseRetrieveUpdateDestroyView.as_view(), name="pedagogical_plan_detail"),
]
